...
import 'package:universal_web/model/menu.dart';
...
import 'package:universal_web/utils/sharedpref.dart';
...
class _HomePageState extends State<HomePage> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    Platform.isAndroid
        ? bannerAdIs
            ? bannerAd2.load()
            : print("Banner Ad Android not loaded")
        : iosBannerAdIs
            ? bannerAd2.load()
            : print("Banner Ad IOS not loaded");
                                  ...
                                  InkWell(
                                    ...
                                    child: Container(
                                      ...
                                      child: Center(
                                          child: CustomText(
                                        title: "Retry",
                                        size: SizeConfig.heightMultiplier * 2.1,
                                        colors: white,
                                        fontWeight: FontWeight.w700,
                                      )),
                                    ),
  ...
  Widget _bottomMenu(WebViewProvider webViewProvider) {
    ...
    final Container adContiner = Container(
